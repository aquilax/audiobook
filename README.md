...
## Idea
1. Store each audio book in separate directory
...
4. Provide `init` command which will create the meta-data template file and optionally search third party for the meta-data
